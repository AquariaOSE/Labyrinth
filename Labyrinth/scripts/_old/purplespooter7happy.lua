...
function init(me)
	setupBasicEntity(
	me,
	"purplespooter7happy/head",						-- texture
	9,							-- health
	2,							-- manaballamount
	2,							-- exp
	10,							-- money
    ...
    entity_initHair(me, 20, 6, 60, "purplespooter7happy/hair")
...
function update(me, dt)
	...
	--entity_touchAvatarDamage(me, entity_getCollideRadius(me), 1, 400)
