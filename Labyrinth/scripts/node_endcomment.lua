...
function update(me, dt)
	...
	if not v.incut and isFlag(TEXT_END, 0) and hasSong(SONG_FISHFORM) and node_isEntityIn(me, n) and v.li ~= 0 then
        ...
        setControlHint("Li, you're home! I'm so glad to see you! You won't believe what I've discovered beneath the ruins of the old labyrinth.  What a day!", 0, 0, 0, 10)
